...
function send(cmd){
  switch(cmd){
    ...
    break;
    default:
      console.log("\n\t\tEse comando no existe!\nPrueba con:\n\t-listarProductos\n\t-listarCarrito (2º arg idUsuario)\n\t-añadirProductoAlCarrito (2º arg idUsuario)(4º argumento id producto así -> [idProducto])\n\t-quitarProductoAlCarrito (2º arg idUsuario)(4º argumento id producto así -> [idProducto])\n");
      process.exit(1);
    break;
  }
}
